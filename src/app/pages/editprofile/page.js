...
function EditProfile() {
    ...
    const [selectedLangInput, setSelectedLangInput] = useState("");
    ...
    // Add language from custom dropdown
    const handleAddLanguage = (lang) => {
        if (lang && !languages.includes(lang)) {
            setLanguages([...languages, lang]);
        }
        setSelectedLangInput("");
        setShowLangDropdown(false);
    };

    // Add region from custom dropdown
    ...
    const filteredLangs = selectedLangInput === ""
        ? allLanguages
        : allLanguages.filter((lang) =>
            lang.toLowerCase().includes(selectedLangInput.toLowerCase())
        );
                ...
                <fieldset className="text-center">
                    ...
                    <div className="relative">
                        <input
                            ...
                            value={selectedLangInput}
                            onChange={e => {
                                setSelectedLangInput(e.target.value);
