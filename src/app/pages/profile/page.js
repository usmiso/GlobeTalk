...
const Profile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setIsEditing(false);
            setProfileLoaded(true);
            setShowNextButton(true); // SHOW NEXT BUTTON AFTER SAVE
        } catch (err) {
    ...
    const handleNext = () => {
        router.push('/pages/avatarUsernameGen'); // redirect
    };
        ...
        <main className="flex flex-col items-center justify-center min-h-screen">
            ...
            {(!profileLoaded || isEditing) ? (
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
                    ...
                    <button
                        className="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 transition mb-3"
