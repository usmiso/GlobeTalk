  ...
  return (
    <main className="flex h-min flex-col md:flex-row overflow-x-hidden">
      ...
      <section className="w-full max-w-fit p-6 lg:hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            ...
            placeholder="Email"
            required
            className="w-full h-12 rounded-2xl border border-neutral-300 bg-white/80 px-4 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-slate-900 focus:ring-2 focus:ring-slate-900/25 transition"
          />
          <button
            type="submit"
            className="w-full h-12 mt-5 rounded-[30px] bg-slate-900 text-white font-semibold hover:bg-slate-800 transition"
          >
            Send Reset Email
          </button>
        </form>
        ...
        <p className="mt-8 mb-7 text-center text-slate-700">
          ...
          <Link href="/pages/signin" className="text-sky-500 hover:underline">
            Sign In
          </Link>
        </p>
      </section>
      ...
      <section className="hidden lg:flex w-full h-screen overflow-hidden">
        {/* LEFT SIDE*/}
        <section className="relative w-1/2 bg-blue-300 rounded-[50px] m-2 overflow-hidden">
        ...
        <section className="w-1/2 h-full flex flex-col items-center justify-start text-center px-8">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4">
            ...
            <input
              ...
              placeholder="Email"
              required
              className="w-full h-12 rounded-2xl border border-neutral-300 bg-white/70 px-4 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-800 focus:ring-2 focus:ring-gray-800/30 transition"
            />
            <button
              type="submit"
              className="w-full h-14 mt-8 rounded-[30px] bg-gray-800 text-white text-lg font-semibold hover:bg-gray-700 transition font-[Roboto_serif]"
            >
              Send Reset Email
            </button>
          </form>
